...
function applyTelegramApiTimeout(telegram, timeoutMs = DEFAULT_TELEGRAM_API_TIMEOUT_MS) {
...
module.exports = { applyTelegramApiTimeout, DEFAULT_TELEGRAM_API_TIMEOUT_MS };
